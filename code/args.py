...
def read_args():
	...
	parser.add_argument('--batch_s', type = int, default = 20000,
				   help = 'batch size')
	parser.add_argument('--mini_batch_s', type = int, default = 2,# 200
	...
	parser.add_argument("--title_abstract_file_path", default = '../data/train/abstract_title.txt', type=str)
	parser.add_argument("--pretrained_path", default = r'../scibert_scivocab_uncased', type=str)
	parser.add_argument("--is_embedding", default = False, type=bool)
